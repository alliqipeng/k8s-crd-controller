...
import (
	...
	examplecomv1 "github.com/alliqipeng/k8s-crd-controller/pkg/apis/example.com/v1"
	versioned "github.com/alliqipeng/k8s-crd-controller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/alliqipeng/k8s-crd-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/alliqipeng/k8s-crd-controller/pkg/client/listers/example.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.NicktmingV1().Databases(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NicktmingV1().Databases(namespace).Watch(options)
			},
		},
